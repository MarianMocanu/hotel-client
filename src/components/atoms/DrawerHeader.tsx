...
import { FaCalendarAlt, FaChevronLeft, FaClock, FaMapMarkerAlt, FaUser } from 'react-icons/fa';
  ...
  return (
    <div className={styles.horizontal}>
      ...
      {(isEvent && eventBooking?.type === 'meeting') &&
            ...
            <p>{eventBooking.start_time} - {eventBooking.end_time}</p>
          </div>
          }
      <div className={styles.horizontal}>
        <div className={styles.icon}>
