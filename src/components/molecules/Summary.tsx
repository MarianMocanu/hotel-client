    ...
    <>
      ...
      <h3>Summary</h3>
          ...
          {booking.addons.length > 0 && 
            booking.addons.map((addon, index) => <p key={index}> <span>{addon.title}</span> <span>{addon.price.toLocaleString('de-DE')} kr.</span> </p>)
          }
        <h3>Total <span>{calculateSubtotal().toLocaleString('de-DE')} kr.</span></h3>
